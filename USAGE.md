...
This repo is **MIT-licensed for original work** authored by Dr Non — original software (`tokens.css`, `components.html`, `quick-start.html`, `packages/`), original writing (DNA docs, philosophy, recipes), original concept sheets, and the original hero illustration `docs/hero-banner.png`.
